...
![Custom Display Format](assets/images/自定义显示格式.png)

![Date Format Adjustment](assets/images/日期格式调整.png)
...
![Folder Information Display](assets/images/文件夹效果演示.png)

👆 Show size, number of files, modification time, etc. when hovering over a folder

![File Information Display](assets/images/文件效果演示.png)

👆 Show size and modification time when hovering over a file

![Compatibility Display](assets/images/兼容性.png)
